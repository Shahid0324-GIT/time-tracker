...
export function BentoGrid() {
  return (
    <section
      id="details"
      className="py-32 bg-black relative overflow-hidden scroll-mt-28"
    >
      {/* Background Gradient Blob */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-blue-500/10 rounded-full blur-[120px] -z-10" />

      <div className="container px-4 md:px-6 mx-auto max-w-7xl">
        {/* Section Header with BlurText */}
        <div className="text-center mb-20 space-y-4 flex flex-col items-center">
          {/* We split this into two lines or components to handle the color highlight nicely */}
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white flex flex-col items-center gap-2">
            <BlurText
          ...
          <motion.p
            ...
            className="text-gray-400 max-w-2xl mx-auto text-lg pt-4"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
          ...
          >
            <div className="h-full flex flex-col justify-between z-10 relative">
              <div className="space-y-2">
                <div className="p-3 bg-cyan-500/10 w-fit rounded-xl border border-cyan-500/20">
          ...
          >
            <div className="h-full flex flex-col justify-between">
              <div className="p-3 bg-yellow-500/10 w-fit rounded-xl border border-yellow-500/20">
          ...
          >
            <div className="h-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
              ...
              <div className="relative w-full md:w-48 h-32 bg-white/5 rounded-xl border border-white/10 p-4 flex flex-col gap-2 rotate-3 group-hover:rotate-0 transition-transform duration-300">
                <div className="h-2 w-1/2 bg-white/20 rounded-full" />
                <div className="h-2 w-3/4 bg-white/10 rounded-full" />
                <div className="h-2 w-full bg-white/10 rounded-full" />
                <div className="mt-auto flex justify-end">
                  <div className="px-3 py-1 rounded-md bg-green-500/20 text-green-400 text-xs font-mono">
                    export_data.csv
                  </div>
                </div>
              </div>
